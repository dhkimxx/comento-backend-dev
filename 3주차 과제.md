...
-> Intellij IDE에서 리소스파일은 resource 폴더 내에서만 인식하기 때문에 **src/main/resources** 가 아닌 **ser/main/java** 에 있는 xml 파일을 mybatis에서 인식하지 못함  
(참고: [Intellij, Spring Boot, Maven빌드, Mybatis xml맵핑 불가 이슈 발생](https://velog.io/@dkatlf900/intellijresourcesissue))
