...
brew를 사용해서 MariaDB 설치(이후 오류 발생: 기존에 사용하던 MySQL과 충돌때문에 기존 MySQL으로 진행)
...
Table 생성, movie_id(Primary Key), movie_name(Not Null), director(Not Null), type(Not Null), moviecol(Not Null)
