...
### 1. 기존에 설치된 JDK 버전 확인(JDK11, JDK8이 설치되어있음)
...
maven-compiler: 3.7.0, source: 1.8, target: 1.8 (maven compiler plugin 또한 JDK8버전 사용)
...
이후 프로젝트 Tomcat server 설정 후 http://localhost:8080/{프로젝트명} 접속
